...
### Methode 2: Met live server (aanbevolen)
- clone de repo
- open terminal in de `public` folder
- run: `npx live-server` of `python -m http.server`
- open browser op `http://localhost:8080`

### Methode 3: Met VS Code
- open de `public` folder in VS Code
- installeer "Live Server" extensie
- klik rechts op `index.html` en kies "Open with Live Server"
...
| 8/04 | Webshop online zetten met netlify | 🔄 In progress |
